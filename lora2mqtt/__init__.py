...
class Log:
    ...
    def print(self, text, error=False, warning=False, sd_notify=False, console=True):
        ...
        if console:
            ...
            if error:
                print(
                    f"{Fore.RED}{Style.BRIGHT}[{timestamp}] {Style.RESET_ALL}{text}{Style.RESET_ALL}",
                    file=sys.stderr,
                )
            elif warning:
                print(
                    f"{Fore.YELLOW}[{timestamp}] {Style.RESET_ALL}{text}{Style.RESET_ALL}"
                )
            else:
                print(
                    f"{Fore.GREEN}[{timestamp}] {Style.RESET_ALL}{text}{Style.RESET_ALL}"
                )
